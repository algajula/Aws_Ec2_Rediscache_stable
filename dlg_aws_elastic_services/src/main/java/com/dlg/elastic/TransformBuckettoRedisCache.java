...
@Component
public class TransformBuckettoRedisCache {
	
	private final static Logger log = LoggerFactory.getLogger(TransformBuckettoRedisCache.class);
	
	@Autowired
	AmazonBucketHelper amazonBucketHelper;
	
	public void gettransformbuckettorediscache(List<PolicyDetailBean> list)throws Exception{
		try{
